...
public:
  ...
  inline       T& Xe(int n, int k, int j, int i)       noexcept { return Xs_data[((n*n3 + k)*n2 + j)*ng + i]; }
  inline const T& Xe(int n, int k, int j, int i) const noexcept { return Xs_data[((n*n3 + k)*n2 + j)*ng + i]; }
  ...
  inline       T& Ye(int n, int k, int j, int i)       noexcept { return Ys_data[((n*n3 + k)*ng + j)*n1 + i]; }
  inline const T& Ye(int n, int k, int j, int i) const noexcept { return Ys_data[((n*n3 + k)*ng + j)*n1 + i]; }
  ...
  inline       T& Ze(int n, int k, int j, int i)       noexcept { return Zs_data[((n*ng + k)*n2 + j)*n1 + i]; }
  inline const T& Ze(int n, int k, int j, int i) const noexcept { return Zs_data[((n*ng + k)*n2 + j)*n1 + i]; }
