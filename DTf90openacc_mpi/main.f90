...
! main loop
  if(myid_w == 0 .and. .not. nooutput )  print *,"step","time","dt","is damped every",nhydis,"step"
  time_begin = omp_get_wtime()
  mloop: do nhy=1,nhymax
     call TimestepControl
     if(mod(nhy,nhydis) .eq. 0  .and. .not. nooutput ) print *,"step=",nhy,"time=",time,"dt=",dt
  ...
  if(myid_w == 0) print *, "exiting main loop time=",time," step=",nhy
